...
import { notificationRouter, tasteRouter, recommendationRouter, searchRouter, loyaltyRouter, disputeRouter, invoiceRouter, locationRouter, couponRouter, adminRouter } from './routes/advanced.routes';
