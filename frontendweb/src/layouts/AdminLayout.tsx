...
import {
  LayoutDashboard, Users, Store, Car, ShoppingBag, Ticket,
  Wallet, FileText, Bell, Menu, X, ChevronDown, Flame, LogOut, Settings
} from 'lucide-react'
      ...
      <div className="p-5 border-b border-gray-100">
        <Link to="/admin" className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-full">
              Admin
            </span>
          </div>
        </Link>
      ...
      >
        {sidebarOpen ? (
          ...
          <div className="flex flex-col items-center py-5 space-y-3">
            <Link to="/admin" className="w-10 h-10 rounded-xl bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center">
              <Flame className="w-5 h-5 text-white" />
            </Link>
            {sidebarItems.map((item) => {
              const Icon = item.icon
                ...
                {userMenuOpen && (
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50">
                      ...
                      <Link to="/admin/settings" className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50">
